...
-- ANIMS
options = CreateOptionsTBL( TF.BC3, 1.0, true, true, false )
package = Package:new( "anims", MaxPackageSize, options )
package:CreateAtlas( TF.BC3, MaxTextureWidth, MaxTextureHeight, AtlasStyle.Decreasing )
PackageFolder( package, "./anims", true )
